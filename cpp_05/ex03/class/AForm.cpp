...
int AForm::getSignGrade(void) const { return (this->signGrade_); }

int AForm::getExecGrade(void) const { return (this->execGrade_); }

bool AForm::getIsAssigned(void) const { return (this->isAssigned_); }
...
void AForm::beSigned(Bureaucrat &bureaucrat) {
  ...
  std::cout << this->getName() << " AForm was signed by "
