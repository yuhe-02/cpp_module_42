...
RobotomyRequestForm::RobotomyRequestForm()
    : AForm("anonymous_RobotomyRequest", 72, 45), target_("anonymous") {
  std::cout << "RobotomyRequestForm " << this->target_ << ": "
...
RobotomyRequestForm::RobotomyRequestForm(const std::string &target)
    : AForm("anonymous_RobotomyRequest", 72, 45), target_(target) {
  std::cout << "RobotomyRequestForm " << this->target_ << ": "
            << "constructor with name called" << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(const RobotomyRequestForm &copy)
    : AForm("anonymous_RobotomyRequest", 72, 45), target_(copy.getTarget()) {
  std::cout << "RobotomyRequestForm " << this->target_ << ": "
