...
int main() {
  ...
  std::cout << std::endl
            << "Creating DiamondTrap2 with parameterized constructor"
            << std::endl;
  ...
  std::cout << std::endl
            << "\nCopying DiamondTrap1 to DiamondTrap3 using copy constructor"
            << std::endl;
  DiamondTrap diamond3(diamond1); // コピーコンストラクタのテスト

  std::cout
      << std::endl
      << "\nAssigning DiamondTrap2 to DiamondTrap4 using assignment operator"
      << std::endl;
