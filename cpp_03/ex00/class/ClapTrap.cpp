...
ClapTrap::ClapTrap(const std::string name)
    : name_(name), hit_points_(DF_HP), energy_points_(DF_EP), attack_damage_(DF_AD)
{
...
ClapTrap::ClapTrap(const ClapTrap &other)
    : name_(other.getName()), hit_points_(other.getHitPoints()), energy_points_(other.getEnergyPoints()),
...
void ClapTrap::attack(const std::string &target)
{
    ...
    std::cout << "ClapTrap " << this->name_ << " attacks " << target << ", causing " << this->attack_damage_
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    std::cout << "ClapTrap " << this->name_ << " is repaired by " << amount << " points." << std::endl;
    this->hit_points_ += amount;
    this->energy_points_--;
}
