...
static const char *memberNames[MEMBER_NUM] = {"first name", "last name", "nick name", "phone number", "darkest secret"};
...
bool Contact::getIsRegistered()
{
    return (this->m_isRegisterd);
}
